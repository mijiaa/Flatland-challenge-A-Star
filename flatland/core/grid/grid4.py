...
class Grid4Transitions(Transitions):
    ...
    Whether a transition is allowed or not depends on which incoming_dir an agent
    inside the cell is facing (0=North, 1=East, 2=South, 3=West) and which
    incoming_dir the agent wants to move to
    (North, East, South, West, relative to the cell).
    Each transition (orientation, incoming_dir)
    ...
    def __init__(self, transitions):
        ...
        # row,col delta for each incoming_dir
    ...
    def get_transitions(self, cell_transition, orientation):
        ...
        in incoming_dir `orientation` and inside a cell with
    ...
    def set_transitions(self, cell_transition, orientation, new_transitions):
        ...
        oriented in incoming_dir `orientation` and inside a cell with transitions
    ...
    def get_transition(self, cell_transition, orientation, direction):
        ...
        oriented in incoming_dir `orientation` and inside a cell with transitions
        `cell_transition' can move to the cell in incoming_dir `incoming_dir`
