...
class TransitionMap:
    ...
    def get_transition(self, cell_id, transition_index):
        ...
        movement along transition `transition_index` (e.g., the NESW incoming_dir
        ...
        transition_index : int
            ...
            get_transitions(). e.g., the NESW incoming_dir of movement, for agents
            on a grid.
...
class GridTransitionMap(TransitionMap):
    ...
    def get_transitions(self, row, column, orientation):
        ...
        cell_id : tuple
            ...
            where orientation is the incoming_dir an agent is facing within a cell.
    ...
    def check_path_exists(self, start: IntVector2DArray, direction: int, end: IntVector2DArray):
        ...
        :param direction: Start incoming_dir for the path we are testing
    ...
    def cell_neighbours_valid(self, rcPos: IntVector2DArray, check_this_cell=False):
        ...
        for iDirOut in giDirOut:
            ...
            gPos2 = grcPos + gdRC  # next cell in that incoming_dir
            ...
            # Get the transitions out of gPos2, using iDirOut as the inbound incoming_dir
    ...
    def fix_transitions(self, rcPos: IntVector2DArray, direction: IntVector2D = -1):
        ...
        # Only one incoming incoming_dir --> Straight line set deadend
    ...
    def validate_new_transition(self, prev_pos: IntVector2D, current_pos: IntVector2D,
        ...
        """
        # start by getting incoming_dir used to get to current node
        # and incoming_dir from current node to possible child node
        ...
        if prev_pos is None:
            if new_trans == 0:
                # need to flip incoming_dir because of how end points are defined
