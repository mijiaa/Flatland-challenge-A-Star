...
def random_schedule_generator(speed_ratio_map: Optional[Mapping[float, float]] = None,
    ...
    """
    Given a `rail` GridTransitionMap, return a random placement of agents (initial position, incoming_dir and target).
    ...
    def generator(rail: GridTransitionMap, num_agents: int, hints: Any = None, num_resets: int = 0,
        ...
        while re_generate:
            ...
            # agents_direction must be a incoming_dir for which a solution is
            # guaranteed.
