...
class gamma_gen(rv_continuous):
    ...
    def fit(self, data, *args, **kwds):
        ...
        if floc != 0:
            # Don't do the subtraction in-position, because `data` might be a
...
class lognorm_gen(rv_continuous):
    ...
    def fit(self, data, *args, **kwds):
        ...
        floc = float(floc)
        if floc != 0:
            # Shifting the data by floc. Don't do the subtraction in-position,
...
class rice_gen(rv_continuous):
    ...
    def _pdf(self, x, b):
        ...
        # in position of the modified Bessel function, i0, improving
