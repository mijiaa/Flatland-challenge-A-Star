...
def rvs_ratio_uniforms(pdf, umax, vmin, vmax, size=1, c=0, random_state=None):
    ...
    umax : float
        The upper bound of the bounding rectangle in the u-incoming_dir.
    vmin : float
        The lower bound of the bounding rectangle in the v-incoming_dir.
    vmax : float
        The upper bound of the bounding rectangle in the v-incoming_dir.
