...
def _get_delta(A, b, c, x, y, z, tau, kappa, gamma, eta, sparse=False,
    ...
    get the search incoming_dir for increments to the variable estimates.
...
def _ip_hsd(A, b, c, c0, alpha0, beta, maxiter, disp, tol, sparse, lstsq,
    ...
    alpha0 : float
        ...
        incoming_dir; see :math:`\beta_3`of [4] Table 8.1
    beta : float
...
def _linprog_ip(c, c0, A, b, callback, postsolve_args, maxiter=1000, tol=1e-8,
    ...
    alpha0 : float (default = 0.99995)
        The maximal step size for Mehrota's predictor-corrector search
        incoming_dir; see :math:`\beta_{3}` of [4]_ Table 8.1.
    ...
    A search incoming_dir is calculated using the predictor-corrector method
    ...
    After calculating the search incoming_dir, the maximum possible step size
