...
def line_search_wolfe1(f, fprime, xk, pk, gfk=None,
                       ...
                       xtol=1e-14):
    """
    As `scalar_search_wolfe1` but do a line search to incoming_dir `pk`
...
def scalar_search_wolfe1(phi, derphi, phi0=None, old_phi0=None, derphi0=None,
    ...
    alpha > 0 is assumed to be a descent incoming_dir.
...
def line_search_wolfe2(f, myfprime, xk, pk, gfk=None, old_fval=None,
    ...
    new_slope : float or None
        The local slope along the search incoming_dir at the
...
def scalar_search_armijo(phi, phi0, derphi0, c1=1e-4, alpha0=1, amin=0):
    ...
    while alpha1 > amin:       # we are assuming alpha>0 is a descent incoming_dir
