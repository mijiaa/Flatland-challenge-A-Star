...
bound) search incoming_dir is considered. For motivation and analysis refer to
...
def select_step(x, J_h, diag_h, g_h, p, p_h, d, Delta, lb, ub, theta):
    ...
    # Compute the reflected incoming_dir.
    r_h = np.copy(p_h)
    ...
    # Reflected incoming_dir will cross first either feasible region or trust
    # region boundary.
    _, to_tr = intersect_trust_region(p_h, r_h, Delta)
    to_bound, _ = step_size_to_bound(x_on_bound, r, lb, ub)

    # Find lower and upper bounds on a step size along the reflected
    # incoming_dir, considering the strict feasibility requirement. There is no
