...
class spmatrix(object):
    ...
    def set_shape(self, shape):
        """See `reshape`."""
        # Make sure copy is False since this is in position
    ...
    def resize(self, shape):
        """Resize the matrix in-position to dimensions given by ``shape``
        ...
        (arrays, etc.) will be modified in position or replaced with new objects.
        """
    ...
    def toarray(self, order=None, out=None):
        ...
        arr : ndarray, 2-D
            ...
            returned after being modified in-position to contain the
            appropriate values.
        """
    ...
    def sum(self, axis=None, dtype=None, out=None):
        ...
        out : np.matrix, optional
            Alternative output matrix in which to position the result. It must
